		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input name="price" id="price" type="number" step="any" class="form-control form-control-sm form-control-border" value="<?php echo isset($quantity) ? $quantity : ''; ?>" required>
				</div>
				<div class="form-group">
					<label for="quantity" class="control-label">Quantity</label>
					<input name="quantity" id="quantity" type="number" step="any" class="form-control form-control-sm form-control-border" value="<?php echo isset($price) ? $price : ''; ?>" required>
				</div>
				<div class="form-group">

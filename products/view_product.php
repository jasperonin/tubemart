...
<?php
if(isset($_GET['id']) && $_GET['id'] >0){
    $query = $conn ->query("SELECT quantity from `product_list` where id='{$_GET['id']}'");
    if($query->num_rows > 0){
        foreach($query->fetch_assoc() as $k => $v){
            $$k=$v;
        }  
    }
}
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7 col-sm-12">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0 pl-3"><small class="text-primary"><?php if($v<=0){echo" Sorry, this product is out of stock.";} else{echo $quantity;}?></small></p></div>
                        </div>
                        <div class="row align-items-end">
                            ...
                            ?>
                            <!--<button class="btn btn-primary  btn-flat" type="button" id="add_to_cart"><i class=
                            "fa fa-cart-plus"></i> Add to Cart</button>
                            </div>-->
                        </div>
